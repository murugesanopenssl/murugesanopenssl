...
mis_interest_url=location_url.indexOf( "mis-interest.html");
inhale_hotwater_ent_url=location_url.indexOf( "inhale-hotwater-ent.html");
...
spending_url=location_url.indexOf( "spending.html");
if( -1 == spending_url )
{
...
{
	document.write( "<TR><TD valign='top' style='width:95px;' align='left'><TABLE style='width:100%'><TR><TD style='width:72px;' id='homepage' valign='top' align='left'><A style='display:block;' onmouseover='OpenHomeMenu()' onclick='OpenHomeMenu()' href='index.html'>Home1 page</A></TD></TR></TABLE>");
	document.getElementById('homepage').style.backgroundColor='violet';
}
else if( ( -1 != My_Drawings_url_01 ) || ( -1 != My_Drawings_url_02 ) )
{
	document.write( "<TR><TD valign='top' style='width:95px;' align='left'><TABLE style='width:100%'><TR><TD style='width:72px;' id='homepage' valign='top' align='left'><A style='display:block;' onmouseover='OpenHomeMenu()' onclick='OpenHomeMenu()' href='index.html'>Home2 page</A></TD></TR></TABLE>");
	document.getElementById('homepage').style.backgroundColor='cyan';
}
else
{
	document.write( "<TR><TD valign='top' style='width:89px;' align='left'><TABLE style='width:100%'><TR><TD style='width:72px;' id='homepage' valign='top' align='left'><A style='display:block;' onmouseover='OpenHomeMenu()' onclick='OpenHomeMenu()'>Homepage</A></TD></TR></TABLE>");
...
*/
if( -1 != openssl_speed_url )
{
	document.write( "<A style='display:block;'><B><U><FONT color='red'>openssl speed</B></U></FONT>");
	document.getElementById('homepage').style.backgroundColor='violet';
}
else
{
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"openssl_speed.html'>openssl speed</A>");
	document.getElementById('homepage').style.backgroundColor='violet';
}
document.write( "</DIV>");
document.write( "</TD>");
...
document.write( "<TABLE style='width:100%'><TR><TD valign='top' align='left'><A style='display:block;' onmouseover='OpenHealthTips()' onclick='OpenHealthTips()' id='moneyhelp01'>HealthTips</A></TD></TR></TABLE>");
...
{
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"inhale-hotwater-ent.html'><FONT color='white'><B><U>&#2951;&#2992;&#3009;&#2990;&#2994;&#3021; &#2970;&#3010;&#2975;&#3006;&#2985; &#2984;&#3008;&#2992;&#3021; &#2953;&#2995;&#3021;&#2995;&#3007;&#2996;&#3009;&#2965;&#3021;&#2965;</B></U></FONT></A>");
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"inhale-hotwater-ent.html'><FONT color='white'>Inhale hotwater ENT</FONT></A>");
}
...
//#{
document.write( "<TD valign='top' style='width:10px;' align='left'>");
document.write( "<TABLE style='width:100%'><TR><TD valign='top' align='left'><A style='display:block;' onmouseover='OpenMoneyHelp01()' onclick='OpenMoneyHelp01()' id='moneyhelp01'>Moneyhelp01</A></TD></TR></TABLE>");
...
{
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"mis-interest.html'><FONT color='white'>&#2997;&#2994;&#3021;&#2994;&#2992;&#2970;&#3009; &#2986;&#2969;&#3021;&#2965;&#2995;&#3007;&#2986;&#3021;&#2986;&#3009;01</FONT></A>");
}
...
// #{
document.write( "<TD valign='top' style='width:10px;' align='left'>");
document.write( "<TABLE style='width:100%'><TR><TD valign='top' align='left'><A style='display:block;' onmouseover='OpenMoneyHelp02()' onclick='OpenMoneyHelp02()' id='moneyhelp02'>Moneyhelp02</A></TD></TR></TABLE>");
document.write( "<DIV id='MoneyHelpPanel02' class='MoneyHelpSidePanel02'>");
document.write( "<A href='javascript:void(0)' class='closebtn' onclick='CloseMoneyHelp()'>x</A>");
if( -1 != BEST_BANK_TO_OPEN_FD_url )
{
	document.write( "<A style='display:block;'><B><U><FONT color='red'>BEST BANK TO OPEN FD</B></U></FONT>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"BEST_BANK_TO_OPEN_FD.html'>BEST BANK TO OPEN FD</A>");
}
if( -1 != Post_office_PPF_deposit_url )
{
	document.write( "<A style='display:block;'><B><U><FONT color='red'>POST PPF Deposit 50.00</B></U></FONT>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"Post_office_PPF_deposit.html'>POST PPF Deposit 50.00</A>");
}
if( -1 != LEARN_SBI_FD_url )
{
	document.write( "<A style='display:block;'><B><U><FONT color='red'>LEARN SBI FD</B></U></FONT>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"LEARN_SBI_FD.html'>LEARN SBI FD</A>");
}
if( -1 != STEPS_TO_OPEN_SBI_ETDR_url )
{
	document.write( "<A><FONT color='red'><B><U>STEPS AT SBI ETDR</B></U></FONT></A>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"how-open-sbi-etdr.html'>STEPS AT SBI ETDR</A>");
}
if( -1 != SBI_ETDR_INTEREST_url )
{
	document.write( "<A><FONT color='red'><B><U>SBI ETDR</B></U></FONT></A>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else if( -1 != Each_Sub_Sbi_Etdr_url )
{
	document.write( "<A href='"+prefix_poemDir+"SBI_ETDR_INTEREST.html'><FONT color='white'><B><U>SBI ETDR</B></U></FONT></A>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"SBI_ETDR_INTEREST.html'>SBI ETDR</A>");
}
if( -1 != TMB_ETDR_INTEREST_url )
{
	document.write( "<A><FONT color='red'><B><U>TMB ETDR</B></U></FONT></A>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"TMB_ETDR_INTEREST.html'>TMB_ETDR</A>");
}
if( -1 != IND_ETDR_INTEREST_url )
{
	document.write( "<A><FONT color='red'>IND_ETDR</FONT></A>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else if( -1 != INDIAN_BANK_ETDR_INT_01_YYYY_6_1_url || -1 != INDIAN_BANK_ETDR_INT_01_YEAR_url )
{
	document.write( "<A href='"+prefix_poemDir+"IND_ETDR_INTEREST.html'><FONT color='white'>IND_ETDR</FONT></A>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"IND_ETDR_INTEREST.html'>IND_ETDR</A>");
}
if( -1 != BNK_CREDIT_INTEREST_url )
{
	document.write( "<A style='display:block;'><B><U><FONT color='red'>BANK CREDIT</B></U></FONT>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"BNK_CREDIT_INTEREST.html'>Bank credit</A>");
}
if( -1 != Donate_url )
{
	document.write( "<A style='display:block;'><B><U><FONT color='red'>BEFORE DONATION</B></U></FONT>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"Donate.html'>Before donation</A>");
}
if( -1 != mydonation_url )
{
	document.write( "<A style='display:block;'><B><U><FONT color='red'>MY DONATIONS</B></U></FONT>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"mydonation.html'>My donations</A>");
}
if( -1 != No_IMPS_ippb_to_Bank_url )
{
	document.write( "<A><FONT color='red'>NO IMPS IPPB TO BANK</fONT></A>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"No_IMPS_ippb_to_Bank.html'>No IMPS ippb to Bank</A>");
}
if( -1 != NEVER_USE_GPAY_MOBILE_RECHARGE_url )
{
	document.write( "<A><FONT color='red'><B><U>NO GPAY RECHARGE</B></U></FONT></A>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"NEVER_USE_GPAY_MOBILE_RECHARGE.html'>No gpay recharge</A>");
}
if( -1 != Tamilnadu_CurrentBill_url )
{
	document.write( "<A><FONT color='red'><B><U>TN TNEB</B></U></FONT></A>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"Tamilnadu_CurrentBill.html'>TN TNEB</A>");
}
if( -1 != Karnataka_CurrentBill_url )
{
	document.write( "<A style='display:block;'><B><U><FONT color='red'>KA BESCOM</B></U></FONT>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"Karnataka_CurrentBill.html'>KA BESCOM</A>");
}
if( -1 != FindIndianRupee_Duplicate_url )
{
	document.write( "<A><FONT color='red'><B><U>DUPLICATE INR</B></U></FONT></A>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"FindIndianRupee-Duplicate.html'>DUPLICATE INR</A>");
}
if( -1 != STEPS_OPENING_POSTOFFICE_ACCOUNT_url )
{
	document.write( "<A><FONT color='red'><B><U>Post office sb opening steps</B></U></FONT></A>");
	document.getElementById('moneyhelp02').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"STEPS_OPENING_POSTOFFICE_ACCOUNT.html'>Post office sb opening steps</A>");
}
document.write( "</DIV>");
document.write( "</TD>");
// #}
...
// #{
document.write( "<TD valign='top' style='width:10px;' align='left'>");
document.write( "<TABLE style='width:100%'><TR><TD valign='top' align='left'><A style='display:block;' onmouseover='OpenMoneyHelp03()' onclick='OpenMoneyHelp03()' id='moneyhelp03'>Moneyhelp03</A></TD></TR></TABLE>");
document.write( "<DIV id='MoneyHelpPanel03' class='MoneyHelpSidePanel03'>");
document.write( "<A href='javascript:void(0)' class='closebtn' onclick='CloseMoneyHelp()'>x</A>");
if( -1 != PostOfficeJointBalance_url )
{
	document.write( "<A><FONT color='red'><B><U>BAL@POST OFFICEJOINT</B></U></FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"PostOfficeJointBalance.html'>Post Office Joint Balance</A>");
}
if( -1 != DoNotWasteMoney_url )
{
...
{
	document.write( "<A href='"+prefix_poemDir+"DoNotWasteMoney.html'>Do not waste money</A>");
}
if( -1 != CurrentBillPayment_url )
{
	document.write( "<A><FONT color='red'><B><U>ELECTRIC BILL PAYMENT</B></U></FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"CurrentBillPayment.html'>Electric bill payment</A>");
}
if( -1 != Steps_to_Close_NPS_After_5_Years_url )
{
	document.write( "<A><FONT color='red'><B><U>NEVER OPEN NPS</B></U></FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"Steps_to_Close_NPS_After_5_Years.html'>NEVER OPEN NPS</A>");
}
if( -1 != HomeChecklist_url )
{
	document.write( "<A><FONT color='red'><B><U>HOME CHECK LIST</B></U></foNT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else if( -1 != HomeChecklist_Page_url )
{
	document.write( "<A href='"+prefix_poemDir+"HomeChecklist.html'><FONT color='white'>Home checklist begin</FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"HomeChecklist.html'>Home check list</A>");
}
if( -1 != PETROL_AIR_PUMP_url )
{
	document.write( "<A><FONT color='red'><B><U>PETROL AIR PUMP</B></U></FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"PETROL_AIR_PUMP.html'>PETROL AIR PUMP</A>");
}
if( -1 != BuyerAction_url )
{
	document.write( "<A><FONT color='red'><B><U>BUYER ACTIONS</B></U></FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"BuyerAction.html'>BuyerActions</A>");
}
if( -1 != TWO_WHEELER_INSURANCE_url )
{
	document.write( "<A><FONT color='red'><B><U>2WHEELER INSURANCE</B></U></FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"2WHEELER_INSURANCE.html'>2WHEELER INSURANCE</A>");
}
if( -1 != SbiRewards_url )
{
	document.write( "<A><FONT color='red'><B><U>SBI DEBIT CARD SBIREWARDS</B></U></FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"SbiRewards.html'>SbiDebitCardSbiRewards</A>");
}
if( -1 != HDFC_AMB_Hacker_url )
{
	document.write( "<A><FONT color='red'><B><U>HDFC AMB HACKER</B></U></FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"HDFC_AMB_Hacker.html'>HDFC AMB Hacker</A>");
}
if( -1 != HandleBankAMB_url )
{
	document.write( "<A><FONT color='red'><B><U>HANDLE BANK AMB</B></U></FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"HandleBankAMB.html'>Handle bank AMB</A>");
}
if( -1 != TVS_MONEY_WASTAGE_url )
{
	document.write( "<A><FONT color='red'>TVS MONEY WASTAGE</fONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"TVS_MONEY_WASTAGE.html'>TVS MONEY WASTAGE</A>");
}
if( -1 != COMPARE_ATM_MOB_PAY_url )
{
	document.write( "<A><FONT color='red'><B><U>ATM GPAY COMPARE</B></U></FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"COMPARE_ATM_MOB_PAY.html'>ATM GPAY COMPARE</A>");
}
if( -1 != MOBILE_postpaid_payment_url )
{
	document.write( "<A><FONT color='red'><B><U>MOBILE POSTPAID PAYMENT</B></U></FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"MOBILE_postpaid_payment.html'>MOBILE postpaid payment</A>");
}
if( -1 != nsc_open_url )
{
	document.write( "<A><FONT color='red'><B><U>OPEN NSC ONLINE</B></U></FONT></A>");
	document.getElementById('moneyhelp03').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"nsc_open.html'>OPEN NSC ONLINE</A>");
}
document.write( "</DIV>");
document.write( "</TD>");
// #}
...
// #{
document.write( "<TD valign='top' style='width:10px;' align='left'>");
document.write( "<TABLE style='width:100%'><TR><TD valign='top' align='left'><A style='display:block;' onmouseover='OpenMoneyHelp04()' onclick='OpenMoneyHelp04()' id='moneyhelp04'>Moneyhelp04</A></TD></TR></TABLE>");
document.write( "<DIV id='MoneyHelpPanel04' class='MoneyHelpSidePanel04'>");
document.write( "<A href='javascript:void(0)' class='closebtn' onclick='CloseMoneyHelp()'>x</A>");
if( -1 != SANI_MUTHU_CALENDAR_url )
{
	document.write( "<A><FONT color='red'><B><U>SANI MUTHU CALENDAR</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"SANI_MUTHU_CALENDAR.html'>SANI MUTHU CALENDAR</A>");
}
if( -1 != UselessGasTaxAgencies_url )
{
	document.write( "<A><FONT color='red'><B><U>GAS TAX AGENCY</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"UselessGasTaxAgencies.html'>GAS TAX AGENCY</A>");
}
if( -1 != LPG_No_tips_delivery_url )
{
	document.write( "<A><FONT color='red'><B><U>LPG NO TIPS</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"LPG_No_tips_delivery.html'>LPG No tips</A>");
}
if( -1 != airtel_recharge_url )
{
	document.write( "<A><FONT color='red'><B><U>MOBILE CHARGE ERR</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"airtel_recharge.html'>MOBILE CHARGE ERR</A>");
}
if( -1 != PostOfficeHolidays_url )
{
	document.write( "<A><FONT color='red'><B><U>POST OFFICE HOLIDAYS</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"PostOfficeHolidays.html'>PostOfficeHolidays</A>");
}
if( -1 != FixedDepositComparisonBanks_url )
{
	document.write( "<A><FONT color='red'><B><U>ETDR AT EACH BANK</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"FixedDepositComparisonBanks.html'>ETDR AT EACH BANK</A>");
}
if( -1 != Indane_gas_ippb_url )
{
	document.write( "<A><FONT color='red'><B><U>IPPB GAS PAYMENT</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"Indane-gas-ippb.html'>IPPB GAS PAYMENT</A>");
}
if( -1 != Pay_Book_Bharat_gas_online_url )
{
	document.write( "<A><FONT color='red'><B><U>NO TIPS TO BUY CYLINDER</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"Pay_Book_Bharat_gas_online.html'>NO TIPS TO BUY CYLINDER</A>");
}
if( -1 != SoapProductCountry_url )
{
	document.write( "<A><FONT color='red'><B><U>SOAP PRODUCT COUNTRY</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"SoapProductCountry.html'>SOAP PRODUCT COUNTRY</A>");
}
if( -1 != rajaji_nagar_ho_url )
{
	document.write( "<A><FONT color='red'><B><U>RAJAJINAGAR POST OFFICE</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"rajaji_nagar_ho.html'>RAJAJINAGAR POST OFFICE</A>");
}
if( -1 != SaveMoney_url )
{
	document.write( "<A><FONT color='red'><B><U><B><U>SAVE MONEY</B></U></B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"SaveMoney.html'><B><U>Save money</B></U></A>");
}
if( -1 != China_Tv_mobile_router_url )
{
	document.write( "<A><FONT color='red'><B><U>CHINA TV MOBILE ROUTER</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"China_Tv_mobile_router.html'>China tv mobile router</A>");
}
if( -1 != ippb_url )
{
	document.write( "<A><FONT color='red'><B><U>INDIA POST APP</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"ippb.html'>INDIA POST APP</A>");
}
if( -1 != Traffic_violation_url )
{
	document.write( "<A><FONT color='red'><B><U>TRAFFIC VIOLATION</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"Traffic_violation.html'>Traffic violation</A>");
}
if( -1 != Traffic_Violation_payment_url )
{
	document.write( "<A><FONT color='red'><B><U>TRAFFIC VIOLATION PAYMENT</B></U></FONT></A>");
	document.getElementById('moneyhelp04').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"Traffic_Violation_payment.html'>Traffic_Violation_payment</A>");
}
document.write( "</DIV>");
document.write( "</TD>");
// #}
...
// {
document.write( "<TD valign='top' style='width:10px;' align='left'>");
document.write( "<TABLE style='width:100%'><TR><TD valign='top' align='left'><A style='display:block;' onmouseover='OpenMoneyHelp05()' onclick='OpenMoneyHelp05()' id='moneyhelp05'>Moneyhelp05</A></TD></TR></TABLE>");
document.write( "<DIV id='MoneyHelpPanel05' class='MoneyHelp05SidePanel05'>");
document.write( "<A href='javascript:void(0)' class='closebtn' onclick='CloseMoneyHelp()'>x</A>");
if( -1 != I_FEEL_RENT_BETTER_THAN_LEASE_url )
{
	document.write( "<A><FONT color='red'><B><U>RENT BETTER THAN LEASE</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"I_FEEL_RENT_BETTER_THAN_LEASE.html'>Rent better than lease</A>");
}
if( -1 != PreventMoney_Wastage_url )
{
	document.write( "<A><FONT color='red'><B><U>PREVENT MONEY WASTAGE</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"PreventMoney_Wastage.html'>Prevent money wastage</A>");
}
if( -1 != IPPB_Transfer_money_url )
{
	document.write( "<A><FONT color='red'><B><U>IPPB TRANSFER MONEY</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"IPPB_Transfer_money.html'>IPPB transfer money</A>");
}
if( -1 != BIDARAGUPPA_GARBAGE_DUMPING_url )
{
	document.write( "<A><FONT color='red'><B><U>BIDARAGUPPA GARBAGE CENTRE</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"BIDARAGUPPA-GARBAGE-DUMPING.html'>Bidaraguppa garbage centre</A>");
}
document.write( "<a href='' onclick='javascript:window.open(\"https://cbseresults.nic.in\");' title='H.S.C results from Tamilnadu at India on Mon 08-May-2023 09:30 AM IST'>TamilNadu cbse HSC Results</a>");
if( -1 != SMS_Hackers_url )
{
	document.write( "<A><FONT color='red'><B><U>SMS HACKERS</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"SMS_Hackers.html'>SMS hackers</A>");
}
if( -1 != block_geocities_url )
{
	document.write( "<A><FONT color='red'><B><U>BLOCK GEOCITIES</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"block_geocities.html'>block geocities</A>");
}
if( -1 != BlockWebSite_url )
{
	document.write( "<A><FONT color='red'><B><U>BLOCK WEBSITE</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"BlockWebSite.html'>Block webSite</A>");
}
if( -1 != NEWS_emails_url )
{
	document.write( "<A><FONT color='red'><B><U>NEWS EMAILS</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"NEWS_emails.html'>NEWS emails</A>");
}
if( -1 != ISRO_emails_url )
{
	document.write( "<A><FONT color='red'><B><U>ISRO EMAILS</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"ISRO_emails.html'>ISRO emails</A>");
}
if( -1 != NPS_emails_url )
{
	document.write( "<A><FONT color='red'><B><U>NPS EMAILS</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"NPS_emails.html'>NPS emails</A>");
}
if( -1 != uninstall_mob_apps_url )
{
	document.write( "<A><FONT color='red'><B><U>UNINSTALL MOB APPS</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"uninstall_mob_apps.html'>uninstall mob apps</A>");
}
if( -1 != ITR_Refund_reissue_url )
{
	document.write( "<A><FONT color='red'><B><U>ITR REFUND REISSUE</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"ITR_Refund_reissue.html'>ITR refund reissue</A>");
}
if( -1 != ITR_Refund_NOT_RECEIVED_url )
{
	document.write( "<A><FONT color='red'><B><U>ITR REFUND NOT RECEIVED</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"ITR_Refund_NOT_RECEIVED.html'>ITR REFUND NOT RECEIVED</A>");
}
if( -1 != Petrol_Usage_Milage_url )
{
	document.write( "<A><FONT color='red'><B><U>IndianOil BP HP PETROL</B></U></FONT></A>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A href='"+prefix_poemDir+"Petrol_Usage_Milage.html'>IndianOil BP HP PETROL</A>");
}
if( -1 != sbi_login_error_url )
{
	document.write( "<A style='display:block;'><B><U><FONT color='red'>NET BANK TIMED OUT ERROR</B></U></FONT>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"sbi-login-error.html'>NET BANK TIMED OUT ERROR</A>");
}
if( -1 != mobile_charge_alarm_url )
{
	document.write( "<A style='display:block;'><B><U><FONT color='red'>MOBILE CHARGE ALARM</B></U></FONT>");
	document.getElementById('moneyhelp05').style.backgroundColor='violet';
	document.getElementById('homepage').style.backgroundColor='';
}
else
{
	document.write( "<A style='display:block;' href='"+prefix_poemDir+"mobile_charge_alarm.html'>MOBILE CHARGE ALARM</A>");
}
document.write( "</DIV>");
document.write( "</TD>");
// #}
...
{
	document.write( "<A href='"+prefix_poemDir+"spending.html'>DO NOT WASTE MONEY</A>");
}
if( -1 != murugesan_openssl_url )
{
